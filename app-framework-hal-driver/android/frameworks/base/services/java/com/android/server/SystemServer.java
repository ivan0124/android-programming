...
import com.android.server.LedManagerService;
import com.android.server.LcdThermalProtectionService;
...
public final class SystemServer {
    ...
    private void startBootstrapServices() {
        ...
        mSystemServiceManager.startBootPhase(SystemService.PHASE_DISPLAY_READY);
        ...
        mSystemServiceManager.startBootPhase(SystemService.PHASE_PACKAGE_MANAGER_READY);
        ...
        startSensorService();
        mSystemServiceManager.startBootPhase(SystemService.PHASE_SENSOR_SERVICE_READY);
    }
    ...
    private void startOtherServices() {
        ...
        // VibratorService vibrator = null; //[PUCDR-1214] Remove unused services from SystemServer
        ...
        //  MmsServiceBroker mmsService = null; //[PUCDR-1214]
        ...
        try {
            ...
            mSystemServiceManager.startService(LedManagerService.class);

            Slog.i(TAG, "LcdThermalProtection Service");
            mSystemServiceManager.startService(LcdThermalProtectionService.class);
            ...
            //[PUCDR-1214] Remove unused services from SystemServer
            /*
