...
import android.hardware.LcdThermalProtectionManager;
import android.hardware.ILcdThermalProtectionManager;
...
//opersys1
        ...
        registerService(Context.LED_SERVICE, LedManager.class,
                new StaticServiceFetcher<LedManager>() {
            @Override
            public LedManager createService() {
                return new LedManager();
            }});

        registerService(Context.LCD_THERMAL_PROTECTION_SERVICE, LcdThermalProtectionManager.class,
                new StaticServiceFetcher<LcdThermalProtectionManager>() {
            @Override
            public LcdThermalProtectionManager createService() {
                return new LcdThermalProtectionManager();
            }});
    }
